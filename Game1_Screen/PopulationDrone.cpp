...
PopulationDrone::PopulationDrone()
{
	imgHuman.loadFromFile("securitydrone.png");
...
bool PopulationDrone::populate()
{
	...
	{
		std::cout << "Drone not loaded";
	}
	else
		std::cout << "Drone image loaded";
...
bool PopulationDrone::drawPeople(float dayTime, float uTime, float deltaTime)
{
	dayTime += 0.5;
